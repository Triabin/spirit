...
ssh -i /path/to/private_key user@hostname # 使用身份验证文件
ssh user@hostname command # 执行远程命令

# 上传文件
scp local_file remote_username@remote_ip:remote_file或rmeote_folder
scp -r local_folder remote_username@remote_ip:remote_folder

# 下载文件
scp remote_username@remote_ip:remote_file local_file或local_folder
